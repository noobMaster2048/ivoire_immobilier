    ...
    <div class="container mx-auto">
        ...
        <div class="vx-row">
            <div class="vx-col w-full mb-6">
                <vs-card fixedHeight>
                    <div slot="header">
                        <h4 class="font-bold text-green-800">Formulaire maison</h4>
                    </div>
                    <div>
                        ...
                        <div class="vx-row pb-6">
                            ...
                            <div class="vx-col w-full sm:w-5/6">
                                <vs-select v-model="form.programme_id" autocomplete class="w-full md:w-2/3" autocomplete :danger="checkprogramme_id" dandger-text="Le programme est obligatoire">
                        ...
                        <div class="vx-row pb-6">
                            <div class="vx-col w-full sm:w-1/6">
                                <span class="text-lg">Quantité</span>
                            </div>
                            <div class="vx-col w-full sm:w-5/6">
                                <vs-input v-model="form.quantite" class="w-full md:w-2/3" :danger="checkquantite" :danger-text="errorquantite"></vs-input>
                            </div>
                        </div>
                        <div class="vx-row">
...
<script>
    ...
    export default {
        ...
        methods: {
            save() {
                this.sending = true;
                this.$inertia.post(this.route('maison.store'), this.form).then(() => {
                    this.Sending = false;
                });
                this.sending = false;
            }
        ...
        computed: {
            ...
            errorquantite() {
                if (this.$page.errors.quantite) {
                    return this.$page.errors.quantite[0]
                }
            },
